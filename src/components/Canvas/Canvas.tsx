...
interface CanvasProp{
    canvas: string[][],
    handlePaint: (e: React.MouseEvent<HTMLDivElement>, rowIndex: number, colIndex: number)=> void,
    handleMouseUp: ()=>void,
    handleMouseDown: (e:React.MouseEvent<HTMLDivElement>,rowIndex:number, colIndex:number)=>void,
}
